...
class UclMatch extends Match {
    ...
    public UclMatch(String matchID,String dateOfMatch,String homeTeam, String awayTeam, int homeScore, int awayScore) {
        super(matchID,dateOfMatch,homeTeam, awayTeam, homeScore, awayScore);
...
class EplMatch extends Match {
    ...
    public EplMatch(String matchID,String dateOfMatch,String homeTeam, String awayTeam, int homeScore, int awayScore, String referee) {
        super(matchID,dateOfMatch,homeTeam, awayTeam, homeScore, awayScore);
